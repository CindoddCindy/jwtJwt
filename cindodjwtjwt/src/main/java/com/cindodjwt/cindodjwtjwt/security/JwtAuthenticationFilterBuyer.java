...
public class JwtAuthenticationFilterBuyer extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            if (StringUtils.hasText(jwt) && buyerTokenProvider.validateBuyerToken(jwt)) {
                Long userId = buyerTokenProvider.getBuyerIdFromJWT(jwt);

                UserDetails userDetails = customDetailServiceBuyer.loadUserById(userId);
