...
public class SellerTokenProvider {
    ...
    public String generateSellerToken(Authentication authentication) {
        ...
        return Jwts.builder()
                .setSubject(Long.toString(sellerPrincipal.getIdSeller()))
    ...
    public Long getSellerIdFromJWT(String token) {
    ...
    public boolean validateSellerToken(String authToken) {
        try {
